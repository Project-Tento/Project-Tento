					...
					<div id="cont" class="mt-0 p-md-5">
								...
								<div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
									...
									==============================================================----------->
												...
												<div class="col-4 text-end">
													<div
														class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
														<i class="fa fa-area-chart text-lg opacity-10"
															aria-hidden="true"></i>
													</div>
												</div>
											</div>
						...
						<div class="dashboard-second-row">
							...
							<div class="row mt-4">
											...
											<div class="row">
												<div class="col-lg-6">
													<div class="d-flex flex-column h-100">
														<h3 class="font-weight-bolder mb-4 pt-2">Check out our courses
														</h3>
								...
								<!-----------------------------------History---------------------------------------->
								<div class="col-lg-5">
									<div class="card h-100 p-2 history-card">
							...
							==============================================================-->
								<div class="col-lg-6">
									<ul class="nav nav-footer justify-content-center justify-content-lg-end">
										...
										<li class="nav-item">
											<a href="" class="nav-link pe-0 text-muted" target="_blank">Terms &
												Conditions</a>
										</li>
									</ul>
								</div>
