                        ...
                        <div class="form">
                            <div class="col-md-12 ">
                                ...
                                <div class="p-2 py-3 profile-info">
                                    ...
                                    <div class="row m-3">
                                        <div class="col-md-8">
                                            <label class="labels" id="get-name" name="get-name">Full Name</label>
                                            <input type="text" class="form-control" value="Alec Thompson" readonly>
                                        </div>
                                        <div class="col-md-8">
                                            <label class="labels" id="email" name="email">Email Adress</label>
                                            <input type="text" class="form-control" value="alecthompson@gmail.com"
                                                readonly>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <label class="labels" id="get-name" name="get-name">Institution</label>
                                            <input type="text" class="form-control" value=""
                                                readonly>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label class="labels" id="get-name" name="get-name">Level</label>
                                                ...
                                                <!-------HIDE WHEN PROFILE EDIT MODE IT ON
                                                        TOGGLE D-NONE CLASS OF LEVEL VALUE CLASS (AND NOT FORM-CONTROL!!!!)
                                                                            ...
                                                                            .
                                                                             .
                                                                            V ----->
                                                <input type="text" class="form-control level-value" value=""
                                                    readonly>
                            ...
                            <button type="submit" class="d-none save-profile-button" >Save profile</button>
                        </div>
